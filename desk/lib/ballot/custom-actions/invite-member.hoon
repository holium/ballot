...
++  on
  ...
  |%
    ++  action
      ...
      =/  welcome  'This is an auto-generated invitation generated by the ballot app.'

      =/  =action:inv
        :^  %invite  %groups  (shaf %group-uid eny.bowl)
        ^-  invite:inv
        [our.bowl %group-push-hook [booth-ship booth-name] member welcome]
